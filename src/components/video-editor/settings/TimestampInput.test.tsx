...
describe("TimestampInput", () => {
	...
	describe("input parsing", () => {
		...
		it("parses zero", () => {
			const onChange = vi.fn();
			render(<TimestampInput label="Start" valueMs={5000} onChange={onChange} />);
			const input = screen.getByRole("textbox");
	...
	describe("clamping", () => {
		...
		it("accepts value exactly at minMs", () => {
			const onChange = vi.fn();
			render(<TimestampInput label="Start" valueMs={5000} minMs={2000} onChange={onChange} />);
			const input = screen.getByRole("textbox");
		...
		it("accepts value exactly at maxMs", () => {
			const onChange = vi.fn();
			render(<TimestampInput label="End" valueMs={5000} maxMs={10000} onChange={onChange} />);
			const input = screen.getByRole("textbox");
	...
	describe("focus/blur behavior", () => {
		it("shows current formatted value on focus", () => {
			render(<TimestampInput label="Start" valueMs={5500} onChange={() => {}} />);
			const input = screen.getByRole("textbox");
		...
		it("allows editing after focus", () => {
			const onChange = vi.fn();
			render(<TimestampInput label="Start" valueMs={5500} onChange={onChange} />);
			const input = screen.getByRole("textbox");
