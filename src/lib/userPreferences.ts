...
export function loadUserPreferences(): UserPreferences {
	...
	return {
		...
		defaultZoomDurationMs: finitePositive(
			raw.defaultZoomDurationMs,
			DEFAULT_PREFS.defaultZoomDurationMs,
			500,
		),
		defaultTrimDurationMs: finitePositive(
			raw.defaultTrimDurationMs,
			DEFAULT_PREFS.defaultTrimDurationMs,
			500,
		),
		defaultSpeedDurationMs: finitePositive(
			raw.defaultSpeedDurationMs,
			DEFAULT_PREFS.defaultSpeedDurationMs,
			500,
		),
	};
}
